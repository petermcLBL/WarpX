...
t := let(name := "warpxfull_rho_80",
    ...
    boxBig0 := var("boxBig0", BoxND([11, n, n, n], TReal)),
    boxBig1 := var("boxBig1", BoxND([11, n, n, nf], TReal)),
    boxBig2 := var("boxBig2", BoxND([6, n, n, nf], TReal)),
    boxBig3 := var("boxBig3", BoxND([6, n, n, n], TReal)),
    ...
    TFCall(
        TDecl(
            TDAG([
                  ...
                  TDAGNode(TGath(fBox([n, n, n])), nth(boxBig0, 9), nth(X, 9)),
                  TDAGNode(TGath(fBox([n, n, n])), nth(boxBig0, 10), nth(X, 10)),
...
c := opts.fftxGen(t);
opts.prettyPrint(c);
PrintTo("warpx-fullstep-rho_80.c", opts.prettyPrint(c));
