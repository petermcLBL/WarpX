...
static const char* CONTRACTION = R"(
    ...
    rmat := TSparseMat([6,11], [
        [0, [0, fcv/norm],
            ...
            [6, -invep0 * fsckv/norm],
            [9, cxpack(0,   fmkx * fx3v/norm)],
            [10, cxpack(0, -fmkx * fx2v/norm)]],
        [1, [1, fcv/norm],
            [3, cxpack(0, fmkz * c2 * fsckv/norm)], 
            [5, cxpack(0, -fmkx * c2 * fsckv/norm)],
            [7, -invep0 * fsckv/norm],
            [9, cxpack(0,   fmky * fx3v/norm)],
            [10, cxpack(0, -fmky * fx2v/norm)]],
        [2, [2, fcv/norm],
            [3, cxpack(0, -fmky * c2 * fsckv/norm)],
            [4,  cxpack(0, fmkx * c2 * fsckv/norm)],
            [8, -invep0 * fsckv/norm],
            [9, cxpack(0,   fmkz * fx3v/norm)],
            [10, cxpack(0, -fmkz * fx2v/norm)]],
